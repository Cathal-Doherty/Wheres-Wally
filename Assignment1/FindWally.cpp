...
Ref_image::Ref_image() { 
	...
	//this pointer reads in the data of the Wally_grey.txt file so that it can be appended to the WallyArray
...
//this is the Large_image class constructor
...
Base_image::Base_image() { 
	//these lines set the values of the height and width of the matrix searched through in the NNS.
